...
public class MainActivity_Covid_Eng extends AppCompatActivity {
    ...
    private Button callBtn, callBtn1, callBtn2, callBtn3, callBtn4,livecoronatestBtn,onlineAppointmentBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main__covid__eng);
        ...
        livecoronatestBtn = findViewById(R.id.livecoronaTest);
        livecoronatestBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotolivexoronatestUrl("https://livecoronatest.com/chat.php?city=Unnamed%20Road&lat=23.820264&lng=90.417367&addr_dist=Unknown&addr_div=Unknown");
            }
        });
        ...
        onlineAppointmentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoonlineappointmentUrl("https://old.bsmmu.edu.bd/e_ticketing/f/fc_appointment");
            }
        });
        ...
        adView = new AdView(this, "189005963057567_191663432791820", AdSize.BANNER_HEIGHT_50);
    ...
    private void gotoonlineappointmentUrl(String s) {
        Uri uri = Uri.parse(s);
        startActivity(new Intent(Intent.ACTION_VIEW, uri));
    }

    private void gotolivexoronatestUrl(String s) {
        Uri uri = Uri.parse(s);
        startActivity(new Intent(Intent.ACTION_VIEW, uri));
    }
    ...
    private void CallButton() {
        ...
        if (number.trim().length() > 0) {
            if (ContextCompat.checkSelfPermission(MainActivity_Covid_Eng.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MainActivity_Covid_Eng.this, new String[]{Manifest.permission.CALL_PHONE}, REQUEST_CALL);
            } else {
