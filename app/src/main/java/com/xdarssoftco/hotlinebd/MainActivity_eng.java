...
public class MainActivity_eng extends AppCompatActivity {

    private static final int REQUEST_CALL = 1;
    private TextView callText, callText1, callText2, callText3, callText4;
    private Button callBtn, callBtn1, callBtn2, callBtn3, callBtn4,coronaupdatepageBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coronaupdatepageBtn = findViewById(R.id.coronaupdate);
        coronaupdatepageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                opencoronaupdatepage();
            }
        });

        //button for Covid hotline
        covidBtn = (Button) findViewById(R.id.callBtn_covid_eng);
        ...
        adView = new AdView(this, "189005963057567_191620212796142", AdSize.BANNER_HEIGHT_50);
    ...
    private void opencoronaupdatepage() {
        Intent intent_covid = new Intent(this, coronaUpdate_eng.class);
    ...
    private void CallButton() {
        ...
        if (number.trim().length() > 0) {
            if (ContextCompat.checkSelfPermission(MainActivity_eng.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MainActivity_eng.this, new String[]{Manifest.permission.CALL_PHONE}, REQUEST_CALL);
            } else {
    ...
    public void openCovidPage() {
        Intent intent_covid = new Intent(this, MainActivity_Covid_Eng.class);
        startActivity(intent_covid);
    }
